...
impl Settings {
    pub fn new() -> Self {
        Self {
            ...
            service_name: env::var("SERVICE_NAME").unwrap_or_else(|_| "customer_api".to_string()),
            database_url: env::var("DATABASE_URL").unwrap_or_else(|_| "postgres://postgres:postgres@localhost:5432/customer_db".to_string()),
